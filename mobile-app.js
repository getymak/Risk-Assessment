...
function generateEvaluation(scores) {
    ...
    return `
        <div class="evaluation-container">
            ...
            <!-- 雷达图区域（桌面端并排显示） -->
            <div class="radar-charts-desktop" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 25px;">
            ...
            <!-- 雷达图区域（手机端非并排显示） -->
            <div class="radar-charts-mobile" style="display: none; margin-bottom: 25px;">
                <div style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.2); margin-bottom: 20px; border: 1px solid #e3f2fd;">
                     <h4 style="margin: 0 0 20px 0; color: #1e40af; font-size: 1.1em; text-align: center; font-weight: bold;">💪 风险承受能力分析</h4>
                     <div style="width: 100%; max-width: 320px; height: 320px; margin: 0 auto; position: relative; overflow: hidden;">
                         <canvas id="abilityRadarChartMobile"></canvas>
                     </div>
                 </div>
                 <div style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 12px rgba(139, 92, 246, 0.2); margin-bottom: 20px; border: 1px solid #f3e8ff;">
                     <h4 style="margin: 0 0 20px 0; color: #7c3aed; font-size: 1.1em; text-align: center; font-weight: bold;">🧠 风险承受态度分析</h4>
                     <div style="width: 100%; max-width: 320px; height: 320px; margin: 0 auto; position: relative; overflow: hidden;">
                         <canvas id="attitudeRadarChartMobile"></canvas>
                     </div>
                 </div>
            </div>
            ...
            <!-- 手机端非并排卡片显示 -->
            <div class="mobile-risk-cards" style="display: none;">
                <!-- 风险承受能力卡片（手机端单独显示） -->
                <div class="eval-card ability-card-mobile" style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); padding: 20px; border-radius: 12px; margin-bottom: 16px; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.2); border: 1px solid #93c5fd;">
                    <div class="card-header" style="text-align: center; margin-bottom: 16px;">
                        <div style="background: #3b82f6; color: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 12px; font-size: 1.5em;">💪</div>
                        <h3 style="color: #1e40af; margin: 0 0 8px 0; font-size: 1.2em; font-weight: bold;">风险承受能力</h3>
                        <div class="score-display" style="background: #3b82f6; color: white; padding: 8px 16px; border-radius: 20px; font-size: 1.1em; font-weight: bold; display: inline-block;">${Math.round(scores.ability.total)}分</div>
                    </div>
                    <div class="card-content">
                        <div class="level-display" style="text-align: center; margin-bottom: 16px;">
                            <span class="level-tag" style="background: #1e40af; color: white; padding: 8px 16px; border-radius: 20px; font-size: 1em; font-weight: bold;">${abilityEval.level}</span>
                        </div>
                        <div style="background: white; padding: 16px; border-radius: 10px; margin-bottom: 12px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
                            <h5 style="color: #1e40af; margin: 0 0 8px 0; font-size: 0.95em; font-weight: 600;">📊 能力评估</h5>
                            <p style="margin: 0; color: #374151; font-size: 0.9em; line-height: 1.5;">${abilityEval.description}</p>
                        </div>
                        <div style="background: #f0f9ff; padding: 16px; border-radius: 10px; border-left: 4px solid #0ea5e9;">
                            <h5 style="color: #0c4a6e; margin: 0 0 8px 0; font-size: 0.95em; font-weight: 600;">💡 实际案例</h5>
                            <p style="margin: 0; color: #0f172a; font-size: 0.9em; line-height: 1.5;">${abilityEval.example}</p>
                        </div>
                    </div>
                </div>

                <!-- 风险承受态度卡片（手机端单独显示） -->
                <div class="eval-card attitude-card-mobile" style="background: linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 100%); padding: 20px; border-radius: 12px; margin-bottom: 16px; box-shadow: 0 4px 12px rgba(139, 92, 246, 0.2); border: 1px solid #c4b5fd;">
                    <div class="card-header" style="text-align: center; margin-bottom: 16px;">
                        <div style="background: #8b5cf6; color: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 12px; font-size: 1.5em;">🧠</div>
                        <h3 style="color: #7c3aed; margin: 0 0 8px 0; font-size: 1.2em; font-weight: bold;">风险承受态度</h3>
                        <div class="score-display" style="background: #8b5cf6; color: white; padding: 8px 16px; border-radius: 20px; font-size: 1.1em; font-weight: bold; display: inline-block;">${Math.round(scores.attitude.total)}分</div>
                    </div>
                    <div class="card-content">
                        <div class="level-display" style="text-align: center; margin-bottom: 16px;">
                            <span class="level-tag" style="background: #7c3aed; color: white; padding: 8px 16px; border-radius: 20px; font-size: 1em; font-weight: bold;">${attitudeEval.level}</span>
                        </div>
                        <div style="background: white; padding: 16px; border-radius: 10px; margin-bottom: 12px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
                            <h5 style="color: #7c3aed; margin: 0 0 8px 0; font-size: 0.95em; font-weight: 600;">🎯 态度分析</h5>
                            <p style="margin: 0; color: #374151; font-size: 0.9em; line-height: 1.5;">${attitudeEval.description}</p>
                        </div>
                        <div style="background: #faf5ff; padding: 16px; border-radius: 10px; border-left: 4px solid #a855f7;">
                            <h5 style="color: #581c87; margin: 0 0 8px 0; font-size: 0.95em; font-weight: 600;">💡 实际案例</h5>
                            <p style="margin: 0; color: #0f172a; font-size: 0.9em; line-height: 1.5;">${attitudeEval.example}</p>
                        </div>
                    </div>
                </div>
            </div>
...
function createMobileRadarChart(scores) {
    // 创建能力雷达图
    const abilityCanvas = document.getElementById('ability-radar-chart');
    if (abilityCanvas) {
        const abilityCtx = abilityCanvas.getContext('2d');
        const abilityLabels = Object.keys(scores.ability.subFeatures);
        const abilityData = abilityLabels.map(label => scores.ability.subFeatures[label].average);
        
        // 设置canvas尺寸适应移动端
        const containerWidth = abilityCanvas.parentElement.clientWidth;
        const screenWidth = window.innerWidth;
        const isMobile = screenWidth <= 768;
        
        let size;
        if (screenWidth <= 360) {
            size = Math.min(containerWidth * 0.9, screenWidth * 0.85);
        } else if (screenWidth <= 480) {
            size = Math.min(containerWidth * 0.85, screenWidth * 0.8);
        } else if (isMobile) {
            size = Math.min(containerWidth * 0.8, screenWidth * 0.75);
        } else {
            size = Math.min(containerWidth - 48, 280);
        }
        
        size = Math.max(size, 180);
        size = Math.min(size, 320);
        
        abilityCanvas.width = size;
        abilityCanvas.height = size;
        abilityCanvas.style.width = size + 'px';
        abilityCanvas.style.height = size + 'px';
        abilityCanvas.style.maxWidth = '100%';
        abilityCanvas.style.maxHeight = '100%';
        abilityCanvas.style.display = 'block';
        abilityCanvas.style.margin = '0 auto';
        
        if (window.abilityRadarChart) {
            window.abilityRadarChart.destroy();
        }
        
        window.abilityRadarChart = new Chart(abilityCtx, {
            type: 'radar',
            data: {
                ...
                scales: {
                    r: {
                        ...
                        ticks: {
                            ...
                            color: '#6b7280',
                            font: {
                                size: screenWidth <= 360 ? 7 : (screenWidth <= 480 ? 8 : (isMobile ? 9 : 10))
                            }
                        },
                        grid: {
                        ...
                        pointLabels: {
                            font: {
                                size: screenWidth <= 360 ? 8 : (screenWidth <= 480 ? 9 : (isMobile ? 10 : 11)),
                                weight: '500'
                            },
                            color: '#374151',
                            padding: screenWidth <= 360 ? 4 : (screenWidth <= 480 ? 5 : (isMobile ? 6 : 8))
                        }
                    }
                },
                animation: {
    ...
    // 创建态度雷达图
    const attitudeCanvas = document.getElementById('attitude-radar-chart');
    if (attitudeCanvas) {
        const attitudeCtx = attitudeCanvas.getContext('2d');
        const attitudeLabels = Object.keys(scores.attitude.subFeatures);
        const attitudeData = attitudeLabels.map(label => scores.attitude.subFeatures[label].average);
        
        // 设置canvas尺寸适应移动端
        const containerWidth = attitudeCanvas.parentElement.clientWidth;
        const screenWidth = window.innerWidth;
        const isMobile = screenWidth <= 768;
        ...
        attitudeCanvas.width = size;
        attitudeCanvas.height = size;
        attitudeCanvas.style.width = size + 'px';
        attitudeCanvas.style.height = size + 'px';
        attitudeCanvas.style.maxWidth = '100%';
        attitudeCanvas.style.maxHeight = '100%';
        attitudeCanvas.style.display = 'block';
        attitudeCanvas.style.margin = '0 auto';
        
        if (window.attitudeRadarChart) {
            window.attitudeRadarChart.destroy();
        }
        
        window.attitudeRadarChart = new Chart(attitudeCtx, {
            type: 'radar',
            data: {
...
function createRadarChart(canvasId, subFeatures, title) {
    ...
    // 根据图表类型设置不同的颜色
    const isAbility = canvasId === 'abilityRadarChart';
    const backgroundColor = isAbility ? 'rgba(59, 130, 246, 0.2)' : 'rgba(139, 92, 246, 0.2)';
    const borderColor = isAbility ? 'rgba(59, 130, 246, 1)' : 'rgba(139, 92, 246, 1)';
    const pointColor = isAbility ? 'rgba(59, 130, 246, 1)' : 'rgba(139, 92, 246, 1)';
...
function createAssetAllocationChart(score) {
    ...
    `;
    titleDiv.innerHTML = `<i class="fas fa-chart-pie" style="margin-right: ${isMobile ? '6px' : '8px'}; color: #3b82f6;"></i>${riskType}投资组合`;
    ...
    const chartSize = isMobile ? '120px' : '160px';
    ...
    const centerSize = isMobile ? '75px' : '100px';
    ...
    centerCircle.innerHTML = `
        <div style="font-size: ${isMobile ? '11px' : '14px'}; color: #3b82f6; font-weight: bold; text-align: center; line-height: 1.2;">${riskType}</div>
        <div style="font-size: ${isMobile ? '8px' : '10px'}; margin-top: ${isMobile ? '2px' : '3px'}; color: #64748b;">配置比例</div>
    `;
    ...
    assetData.labels.forEach((label, index) => {
        ...
        labelDiv.innerHTML = `
            <span><span style="display: inline-block; width: ${isMobile ? '8px' : '12px'}; height: ${isMobile ? '8px' : '12px'}; border-radius: 50%; background-color: ${assetData.colors[index]}; margin-right: ${isMobile ? '6px' : '8px'};"></span>${label}</span>
    ...
    `;
    tipDiv.innerHTML = `
        <i class="fas fa-hand-pointer" style="margin-right: ${isMobile ? '6px' : '8px'};"></i>
        点击条形图查看详细的资产配置信息
    `;
...
function createAbilityRadarChart(scores) {
    // 桌面版雷达图
    const desktopCanvas = document.getElementById('abilityRadarChart');
    if (desktopCanvas) {
        createRadarChart('abilityRadarChart', scores.ability.subFeatures, '风险承受能力');
    }
    
    // 手机版雷达图
    const mobileCanvas = document.getElementById('abilityRadarChartMobile');
    if (mobileCanvas) {
        createRadarChart('abilityRadarChartMobile', scores.ability.subFeatures, '风险承受能力');
    }
}
...
function createAttitudeRadarChart(scores) {
    // 桌面版雷达图
    const desktopCanvas = document.getElementById('attitudeRadarChart');
    if (desktopCanvas) {
        createRadarChart('attitudeRadarChart', scores.attitude.subFeatures, '风险承受态度');
    }
    
    // 手机版雷达图
    const mobileCanvas = document.getElementById('attitudeRadarChartMobile');
    if (mobileCanvas) {
        createRadarChart('attitudeRadarChartMobile', scores.attitude.subFeatures, '风险承受态度');
    }
}
